...
public class ProviderAuthControllerTest {
    ...
    @InjectMocks
    private ProviderAuthController providerAuthController;
    ...
    */
    ...
    public void testRegisterProvider_SuccessfulRegistration_ShouldReturnOk() throws Exception {
        mockMvc = MockMvcBuilders.standaloneSetup(providerAuthController).build();
        ...
        mockMvc.perform(post("/api/v1/auth/provider/register")
    ...
    */
    ...
    public void testRegisterProvider_SuccessfulLogin_ShouldReturnOk() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/auth/provider/login")
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(asJsonString(request))
                                .accept(MediaType.APPLICATION_JSON))
